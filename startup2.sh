...
<head>
  ...
  <style>
    ...
    .bgimg {
      background-image: url('https://www.panoply.tc/wp-content/uploads/2018/03/DJI_0182.jpg');
      min-height: 100%;
...
<body>
  <div class="bgimg w3-display-container w3-animate-opacity w3-text-white">
    ...
    <div class="w3-display-middle w3-center">
      <iframe src="https://giphy.com/embed/CZedlPSpZ6hKo"
              width="500"
              height="270"
    ...
    <div class="w3-display-bottomleft w3-padding-small transparent-background outlined-text">
      <h1>I Carlton, Thank you Theo, and Beron!</h1>
      <h1>Team Leader: Carlton</h1>
      <h3></h3>
